...
public class MpesaController {
    ...
    private String confirmationURL="https://techsavanna.net:3000/Mpesa/confirm/v1";
    private String validationURL="https://techsavanna.net:3000/Mpesa/validate/v1";
    ...
    private String callBackURL = "https://techsavanna.net:3000/mpesa/api/stkcallback/v1";
    ...
    private String amount;
     ...
     private String completeUrl="http://localhost:443/stkpush/stkpush/example/confirm2.php";
   ...
   // public String STKPushSimulation(String businessShortCode, String password, String timestamp, String transactionType, Long amount, Long phoneNumber, Long partyA, String partyB, String callBackURL, String queueTimeOutURL, String accountReference, String transactionDesc) throws JSONException, IOException {
    ...
    public STKPush STKPushSimulation(@Valid @RequestBody STKPushRequest sRequest) throws IOException, JSONException {
    	authenticate();
       ...
       // STKPushSimulation(businessNo, pass, timestamp, TransactionType, sRequest.getAmount(), sRequest.getPhone(), sRequest.getPhone(), businessNo, callBackURL, queueTimeOutURL, sRequest.getAccountReference(), sRequest.getTransactionDesc());
        ...
        jsonObject.put("BusinessShortCode", businessNo);
        jsonObject.put("Password", pass);
        jsonObject.put("Timestamp", timestamp);
        jsonObject.put("TransactionType", TransactionType);
        jsonObject.put("Amount", sRequest.getAmount());
        //System.out.println(jsonObject.put("Amount", amount));
        jsonObject.put("PhoneNumber", sRequest.getPhone());
        jsonObject.put("PartyA", sRequest.getPhone());
        jsonObject.put("PartyB", businessNo);
        jsonObject.put("CallBackURL", callBackURL);
        jsonObject.put("AccountReference", sRequest.getAccountReference());
        jsonObject.put("QueueTimeOutURL", queueTimeOutURL);
        jsonObject.put("TransactionDesc", sRequest.getTransactionDesc());
       ...
       // System.out.println(response.body().string());
        ...
        STKPush push = new STKPush(businessNo,pass,timestamp,TransactionType,sRequest.getAmount(),sRequest.getPhone(),sRequest.getPhone(),businessNo,callBackURL,queueTimeOutURL,sRequest.getAccountReference(),sRequest.getTransactionDesc(),MerchantRequestID,CheckoutRequestID,ResponseCode,CustomerMessage,null,null,ResponseDescription,null);
